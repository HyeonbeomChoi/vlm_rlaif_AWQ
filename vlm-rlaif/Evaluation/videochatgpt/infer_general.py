...
def parse_args():
    ...
    parser.add_argument("--awq_path", type=str, default=None)
...
def _load_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(args.model_path, args.model_base, 
                                                                           ...
                                                                           device=args.device, awq=args.awq, awq_path=args.awq_path,
...
def run_inference(args):
    ...
    output_list.append({"total_inference_time_seconds": elapsed_time})
...
if __name__ == "__main__":
    args = parse_args()
    if args.awq:
        print(f"Using AWQ from {args.awq_path}")
    run_inference(args)